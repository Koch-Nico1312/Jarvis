...
class PerformanceMonitor:
    ...
    def track_tool_execution(
        ...
        with self._lock:
            ...
            logger.debug(f"Tool execution tracked: {tool_name}/{action} - {duration_ms:.2f}ms - {'SUCCESS' if success else 'FAILED'}")
    ...
    def track_latency(
        ...
        with self._lock:
            ...
            logger.debug(f"Latency tracked: {operation_type} - total={total_duration_ms:.2f}ms, "
    ...
    def get_tool_stats(self, tool_name: Optional[str] = None, action: Optional[str] = None) -> Dict[str, Any]:
        """
