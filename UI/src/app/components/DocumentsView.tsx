    ...
    <div className="h-full p-8 overflow-y-auto">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-sm text-[#8AAEE0]">Verwalte Dateien, Ordner und Wissensquellen</p>
          {currentFile ? (
            <div className="mt-2 inline-flex rounded-full border border-[#638ECB]/30 bg-[#638ECB]/10 px-3 py-1 text-xs text-[#395886]">
